...
export function BetActions({
  ...
  return (
    <div className="relative h-1/2 max-w-80 flex-1 py-8 pr-4">
      <span className="absolute left-4 top-0 mx-auto text-xs font-bold text-text md:text-base">
        *Ball in game {inGameBallsCount}/20
      </span>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-stretch gap-1 md:flex-col">
            <div className="w-full text-sm font-bold md:text-base">
              <div className="flex flex-1 items-stretch justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{currencyFormat(betValue)}</span>
                </div>
              </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="block rounded-md bg-purple px-2 py-4 text-xl font-bold leading-none text-background transition-colors hover:bg-purpleDark focus:outline-none focus:ring-1 focus:ring-purple focus:ring-offset-1 focus:ring-offset-primary disabled:bg-gray-500 md:hidden"
            >
              Bet
            </button>
          </div>
