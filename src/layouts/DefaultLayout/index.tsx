...
export function DefaultLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col justify-between bg-background">
      <Navbar />
      <div className="flex h-full w-full max-w-[1400px] flex-1 overflow-auto overflow-x-hidden pt-4 lg:mx-auto md:mx-auto sm:mx-auto ">
        <div className="flex-1 h-full w-full max-w-[1400px] overflow-auto overflow-x-hidden pt-4 lg:mx-auto md:mx-auto sm:mx-auto">{isLoading ? <Loading /> : <Outlet />}</div>
      </div>
      <Footer />
    </div>
  )
